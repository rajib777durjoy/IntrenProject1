...
const Category = () => {
    return (
        <div className=' w-[90%] mx-auto py-4 min-h-screen mt-10'>
            {/* title */}
            ...
            <div className='w-[100%] grid md:grid-cols-2 lg:grid-cols-4 gap-10 py-5 md:mt-16 '>
                ...
                <div className=' rounded-xl  '>
                    ...
                    <p className='text-[#5E6282] font-medium text-[22px]'>Built Wicket longer admire do barton vanity itself do in it.</p>
                </div>
                <div className=' rounded-xl  '>
                    <img src="/airplane.png" alt="" className='w-[50%] h-[150px] mx-auto' />
                    <h2 className='text-[#1E1D4C] font-semibold text-[26px]'>Best Flights </h2>
                    <p className='text-[#5E6282] font-medium text-[22px]'>Engrossed listening. Park gate sell they west hard for the.</p>
                </div>

                <div className='  rounded-xl'>
                    <img src="/Icon3.png" alt="" className='w-[50%] h-[150px] mx-auto' />
                    <h2 className='text-[#1E1D4C] font-semibold text-[26px]'>Local Events </h2>
                    <p className='text-[#5E6282] font-medium text-[22px]'>Barton vanity itself do in it. Preferd to men it engrossed listening. </p>
                </div>
                <div className='  rounded-xl '>
                    <img src="/Icon4.png" alt="" className='w-[50%] h-[150px] mx-auto' />
                    <h2 className='text-[#1E1D4C] font-semibold text-[26px]'>Customization </h2>
                    <p className='text-[#5E6282] font-medium text-[22px]'>We deliver outsourced aviation services formilitary customers</p>
                </div>
